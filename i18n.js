const translations = new Map(Object.entries({
  ...
  "Simulation dynamique explicite d’un absorbeur de choc élastoplastique avec contact et frottement par éléments finis": "Explicit dynamic finite-element simulation of an elastoplastic shock absorber with contact and friction",
  "Approximation variationnelle de l’équation de Laplace 2D par éléments finis quadrangulaires Q1 et étude de convergence": "Variational approximation of the 2D Laplace equation using Q1 quadrilateral finite elements and convergence analysis",
  "Résolution transitoire de l’équation de la chaleur 1D par schémas d’Euler et de Crank–Nicolson : stabilité et convergence": "Transient solution of the 1D heat equation using Euler and Crank–Nicolson schemes: stability and convergence",
  "Résolution du problème de Dirichlet pour l’équation de Laplace 2D par différences finies en Fortran90": "Finite-difference solution of the Dirichlet problem for the 2D Laplace equation in Fortran90",
  "Analyse des phénomènes hydrodynamiques de surface libre et des contraintes structurelles du drone marin MANTA": "Analysis of free-surface hydrodynamic phenomena and structural stresses in the MANTA marine drone",
  "Analyse de consistance, stabilité et diffusion–dispersion numériques de schémas aux différences finies pour l’équation de transport 1D": "Analysis of consistency, stability and numerical diffusion–dispersion of finite-difference schemes for the 1D transport equation",
  "Analyse d’erreur et d’ordre de convergence des méthodes de quadrature : rectangles, point milieu, trapèzes et Simpson": "Error and convergence-order analysis of quadrature methods: rectangle, midpoint, trapezoidal and Simpson rules",
  "Analyse de stabilité et d’ordre de convergence des schémas d’Euler et de Runge–Kutta pour des EDO du premier ordre": "Stability and convergence-order analysis of Euler and Runge–Kutta schemes for first-order ODEs",
  "Interpolation polynomiale et par splines : analyse du phénomène de Runge et influence des nœuds de Tchebychev": "Polynomial and spline interpolation: analysis of the Runge phenomenon and the influence of Chebyshev nodes",
  "Analyse des compromis aérodynamiques et structurels dans la conception du Halo de Formule 1": "Analysis of aerodynamic and structural trade-offs in the design of the Formula 1 Halo",
